class CreateAddresses < ActiveRecord::Migration
  def self.up
    create_table :addresses, :force => true do |t|
      ...
      t.integer :area_id, :county_id, :city_id, :province_id
    ...
    add_index :provinces, :abbreviation
    ...
    execute "INSERT INTO `provinces` (`id`, `name`, `abbreviation`) VALUES
    (110000, '北京市', '京'),
    (120000, '天津市', '津'),
    (130000, '河北省', '冀'),
    (140000, '山西省', '晋'),
    ...
    execute "INSERT INTO `cities` (`id`, `name`, `province_id`) VALUES
    (110100, '市辖区', 110000),
    (110200, '县', 110000),
    (120100, '市辖区', 120000),
    (120200, '县', 120000),
    ...
    execute "INSERT INTO `counties` (`id`, `name`, `city_id`) VALUES
    (110101, '东城区', 110100),
    (110102, '西城区', 110100),
    (110103, '崇文区', 110100),
    (110104, '宣武区', 110100),
